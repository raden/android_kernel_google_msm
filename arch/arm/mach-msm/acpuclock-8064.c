...
//	[16] = { { 1161000, HFPLL, 1, 0x2B }, 1150000, 1150000, 5 },
#else
...
static struct acpu_level tbl_slow[] __initdata = {
        ...
        { 0, {    81000, HFPLL, 2, 0x06 }, L2(0),   625000 },
...
static struct acpu_level tbl_nom[] __initdata = {
        ...
        { 0, {   192000, PLL_8, 0, 0x00 }, L2(0),   725000 },
        { 1, {   216000, HFPLL, 2, 0x10 }, L2(0),   750000 },
        { 0, {   270000, HFPLL, 2, 0x14 }, L2(0),   775000 },
	{ 0, {   384000, PLL_8, 0, 0x00 }, L2(1),   800000 },
#else
...
//	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(0),   850000 },
	...
	{ 0, {  1512000, HFPLL, 1, 0x38 }, L2(15), 1125000 },
	{ 0, { 0 } }
};
