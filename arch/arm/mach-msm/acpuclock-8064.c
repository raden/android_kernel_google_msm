...
static struct l2_level l2_freq_tbl[] __initdata = {
        ...
        [0]  = { {  27000, HFPLL, 2, 0x02 },  945000, 945000, 1 },
//	[0]  = { {  378000, HFPLL, 2, 0x1C },  945000, 945000, 1 },
	[1]  = { {  384000, PLL_8, 0, 0x00 },  945000, 9450000, 1 },
...
//        [0]  = { {  27000, HFPLL, 2, 0x02 },   945000,  945000, 1 },
	...
	[6]  = { {  756000, HFPLL, 1, 0x1C }, 1150000, 1150000, 4 },
	[7]  = { {  810000, HFPLL, 1, 0x1E }, 1150000, 1150000, 4 },
	[8]  = { {  864000, HFPLL, 1, 0x20 }, 1150000, 1150000, 4 },
	[9] =  { {  918000, HFPLL, 1, 0x22 }, 1150000, 1150000, 5 },
	[10] = { {  972000, HFPLL, 1, 0x24 }, 1150000, 1150000, 5 },
	[11] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1150000, 5 },
	[12] = { { 1080000, HFPLL, 1, 0x28 }, 1150000, 1150000, 5 },
	[13] = { { 1134000, HFPLL, 1, 0x2A }, 1150000, 1150000, 5 },
	[14] = { { 1188000, HFPLL, 1, 0x2C }, 1150000, 1150000, 5 },
	[15] = { { 1674000, HFPLL, 1, 0x3E }, 1150000, 1150000, 5 },
//	[15] = { { 1890000, HFPLL, 1, 0x46 }, 1150000, 1150000, 5 },
//	[15] = { { 1971000, HFPLL, 1, 0x49 }, 1150000, 1150000, 5 },
...
static struct acpu_level tbl_slow[] __initdata = {
        ...
        { 0, {    81000, HFPLL, 2, 0x06 }, L2(0),   675000 },
        { 1, {   108000, HFPLL, 2, 0x08 }, L2(0),   650000 },
        { 1, {   135000, HFPLL, 2, 0x0A }, L2(0),   675000 },
        ...
        { 0, {   384000, PLL_8, 0, 0x00 }, L2(1),   950000 },
...
static struct acpu_level tbl_nom[] __initdata = {
        ...
        { 1, {    27000, HFPLL, 2, 0x02 }, L2(0),   600000 },
        { 1, {    54000, HFPLL, 2, 0x04 }, L2(0),   625000 },
        { 0, {    81000, HFPLL, 2, 0x06 }, L2(0),   700000 },
        { 1, {   108000, HFPLL, 2, 0x08 }, L2(0),   675000 },
...
//	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(0),   800000 },
	...
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   825000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(5),   850000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   850000 },
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),   875000 },
...
#ifdef CONFIG_LOW_CPUCLOCKS
        { 1, {    27000, HFPLL, 2, 0x02 }, L2(0),   650000 },
        { 1, {    54000, HFPLL, 2, 0x04 }, L2(0),   675000 },
        { 0, {    81000, HFPLL, 2, 0x06 }, L2(0),   700000 },
        { 1, {   108000, HFPLL, 2, 0x08 }, L2(0),   725000 },
        { 1, {   135000, HFPLL, 2, 0x0A }, L2(0),   725000 },
        { 0, {   189000, HFPLL, 2, 0x0E }, L2(0),   750000 },
        { 0, {   192000, PLL_8, 0, 0x00 }, L2(0),   750000 },
        { 1, {   216000, HFPLL, 2, 0x10 }, L2(0),   775000 },
//	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   725000 },
//	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(0),   750000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(1),   775000 },
#else
	{ 0, {    54000, HFPLL, 2, 0x04 }, L2(0),   625000 },
        { 0, {   270000, HFPLL, 2, 0x14 }, L2(0),   825000 },
	...
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),   825000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   825000 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(5),   875000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(5),   875000 },
...
#ifdef CONFIG_LOW_CPUCLOCKS
        { 1, {    27000, HFPLL, 2, 0x02 }, L2(0),   700000 },
        { 1, {    54000, HFPLL, 2, 0x04 }, L2(0),   725000 },
        { 0, {    81000, HFPLL, 2, 0x06 }, L2(0),   725000 },
        { 1, {   108000, HFPLL, 2, 0x08 }, L2(0),   750000 },
        { 1, {   135000, HFPLL, 2, 0x0A }, L2(0),   750000 },
        { 0, {   189000, HFPLL, 2, 0x0E }, L2(0),   775000 },
        { 0, {   192000, PLL_8, 0, 0x00 }, L2(0),   775000 },
        { 1, {   216000, HFPLL, 2, 0x10 }, L2(0),   775000 },
//	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   825000 },
//	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(0),   850000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(1),   775000 },
