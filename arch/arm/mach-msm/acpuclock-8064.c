...
#ifdef CONFIG_LOW_CPUCLOCKS
	{ 1, {    27000, HFPLL, 2, 0x02 }, L2(0),   300000 },
	{ 1, {    54000, HFPLL, 2, 0x04 }, L2(0),   600000 },
	{ 0, {    81000, HFPLL, 2, 0x06 }, L2(0),   800000 },
	{ 1, {   108000, HFPLL, 2, 0x08 }, L2(0),   700000 },
	{ 1, {   189000, HFPLL, 2, 0x0E }, L2(0),   800000 },
 	{ 0, {   192000, PLL_8, 0, 0x00 }, L2(0),   825000 },
...
#ifdef CONFIG_LOW_CPUCLOCKS
	{ 1, {    27000, HFPLL, 2, 0x02 }, L2(0),   500000 },
...
static struct acpu_level tbl_fast[] __initdata = {
       ...
       { 0, {   270000, HFPLL, 2, 0x14 }, L2(0),   725000 },
       { 0, {   378000, HFPLL, 2, 0x1C }, L2(0),   750000 },
       { 0, {   384000, PLL_8, 0, 0x00 }, L2(1),   750000 },
#else
...
static struct acpu_level tbl_faster[] __initdata = {
       ...
       { 0, {   192000, PLL_8, 0, 0x00 }, L2(0),   800000 },      
       { 0, {   270000, HFPLL, 2, 0x14 }, L2(0),   825000 },
