...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SELADANG)
extern struct cpufreq_governor cpufreq_gov_seladang;
#define CPUFREQ_DEFAULT_GOVERNOR  (&cpufreq_gov_seladang)
